...
public abstract class BeanObject implements Serializable {
    ...
    public final String toString() {
        ...
        return switch (stringType) {
            case XML -> this.toXML(outputConfig.formatted(), outputConfig.encoding());
            case JSON -> outputConfig.formatted() ? this.toFormattedJson() : this.toJson();
            case YAML -> outputConfig.formatted() ? this.toFormattedYaml() : this.toYaml();
     ...
     */
    private record CDataStreamWriter(XMLStreamWriter xmlStreamWriter) implements XMLStreamWriter {
        /**
         * Instantiates a new C data stream writer.
         *
         * @param xmlStreamWriter the xml stream writer
         */
        private CDataStreamWriter {
        }
        ...
        /**
         * Write a DTD section.
         * This string represents the entire doc type decl production
         ...
         * namespaces.
         * This method may only be called once at the start of
         * the document.
