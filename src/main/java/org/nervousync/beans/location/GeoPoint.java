...
/**
 * <h2 class="en">Geography point define</h2>
 * <h2 class="zh-CN">地理位置信息定义</h2>
 *
 * @author Steven Wee	<a href="mailto:wmkm0113@Hotmail.com">wmkm0113@Hotmail.com</a>
 * @version $Revision: 1.0.0 $ $Date: Dec 19, 2017 13:03:40 $
 */
public final class GeoPoint implements Serializable {
	...
	/**
	 * <span class="en">Enumeration value of GeoPoint.LocationType</span>
	 * <span class="zh-CN">地理坐标类型枚举值</span>
	 * @see GeoPoint.LocationType
	 */
	private final LocationType locationType;
	/**
	 * <span class="en">Longitude value of GeoPoint</span>
	 * <span class="zh-CN">地理坐标经度值</span>
	 */
	private final double longitude;
	/**
	 * <span class="en">Latitude value of GeoPoint</span>
	 * <span class="zh-CN">地理坐标纬度值</span>
	 */
	private final double latitude;

	/**
	 * <h3 class="en">Constructor for GeoPoint</h3>
	 * <h3 class="zh-CN">GeoPoint默认构造方法</h3>
	 *
	 * @param locationType	<span class="en">Enumeration value of GeoPoint.LocationType</span>
	 *                      <span class="zh-CN">地理坐标类型枚举值</span>
	...
	/**
	 * <h3 class="en">Static method for initialize GPS GeoPoint by given location (longitude, latitude)</h3>
	 ...
	 * @param latitude		<span class="en">Latitude value of GeoPoint</span>
	 *                      <span class="zh-CN">地理坐标纬度值</span>
	 * @return	<span class="en">Initialized GeoPoint instance</span>
	 * 			<span class="en">初始化的GeoPoint实例对象</span>
	 */
	...
	/**
	 * <h3 class="en">Static method for initialize GCJ02 GeoPoint by given location (longitude, latitude)</h3>
	...
	/**
	 * <h3 class="en">Static method for initialize BD09 GeoPoint by given location (longitude, latitude)</h3>
	...
	/**
	 * <h3 class="en">Static method for initialize Delta GeoPoint by given location (longitude, latitude)</h3>
	...
	/**
	 * <h3 class="en">Getter method for location type</h3>
	 * <h3 class="zh-CN">坐标类型的Getter方法</h3>
	 *
	 * @return    <span class="en">Value of location type</span>
	...
	/**
	 * <h3 class="en">Getter method for location longitude</h3>
	 * <h3 class="zh-CN">坐标经度值的Getter方法</h3>
	 *
	 * @return    <span class="en">Value of location longitude</span>
	...
	/**
	 * <h3 class="en">Getter method for location latitude</h3>
	 * <h3 class="zh-CN">坐标纬度值的Getter方法</h3>
	 *
	 * @return    <span class="en">Value of location latitude</span>
	...
	/**
	 * <h3 class="en">Override method for toString</h3>
	 * <p class="en">
	...
	/**
	 * <h2 class="en">Enumeration define for LocationType</h2>
	 * <h2 class="zh-CN">LocationType枚举类定义</h2>
	 */
	public enum LocationType {
		/**
         * <span class="en">GPS/WGS84 Record</span>
         * <span class="zh-CN">GPS/WGS84坐标</span>
		 */
		GPS,
		/**
         * <span class="en">GCJ-02 Record</span>
         * <span class="zh-CN">GCJ-02坐标</span>
		 */
		GCJ_02,
		/**
         * <span class="en">BD-09 Record</span>
         * <span class="zh-CN">GCJ02坐标</span>
		 */
		BD_09,
		/**
         * <span class="en">DELTA Record, using for convert between the location types</span>
