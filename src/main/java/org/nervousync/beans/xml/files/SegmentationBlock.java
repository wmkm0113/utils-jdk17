...
/**
 * <h2 class="en">Segment Data Block Define</h2>
...
public final class SegmentationBlock extends BeanObject {
	...
	/**
	 * <span class="en">Block begin position</span>
	 * <span class="zh-CN">数据块起始地址</span>
	 */
	@XmlElement(name = "position")
	private long position;
	/**
	 * <span class="en">Block data size</span>
	 * <span class="zh-CN">数据块大小</span>
	 */
	@XmlElement(name = "block_size")
	private long blockSize;
	/**
	 * <span class="en">Block data identified value of SHA256</span>
	 * <span class="zh-CN">数据块验证值，使用SHA256</span>
	 */
	@XmlElement(name = "signature_sha")
	private String sha;
	/**
	 * <span class="en">Block data information, base64 encoded data bytes</span>
	...
	/**
	 * <span class="en">Block generate time</span>
	...
	/**
     * <h3 class="en">Default constructor for SegmentationBlock</h3>
     * <h3 class="zh-CN">SegmentationBlock的默认构造函数</h3>
	 */
	public SegmentationBlock() {
	}
	/**
     * <h3 class="en">Constructor for SegmentationBlock</h3>
     * <span class="en">Using given block begin position and binary array of data content</span>
     * <h3 class="zh-CN">SegmentationBlock的构造函数</h3>
     * <span class="zh-CN">使用给定的数据块起始地址和数据的字节数组</span>
	 *
	 * @param position    <span class="en">Block begin position</span>
	 *                    <span class="zh-CN">数据块起始地址</span>
	 * @param dataContent <span class="en">Binary array of data content</span>
    ...
    /**
	 * <h3 class="en">Getter method for block begin position</h3>
	 * <h3 class="zh-CN">数据块起始地址的Getter方法</h3>
	 *
	 * @return 	<span class="en">Block begin position</span>
	 * 			<span class="zh-CN">数据块起始地址</span>
	 */
    ...
    /**
	 * <h3 class="en">Getter method for block size</h3>
	 * <h3 class="zh-CN">数据块长度的Getter方法</h3>
	 *
	 * @return 	<span class="en">Block data size</span>
	 * 			<span class="zh-CN">数据块大小</span>
	 */
    ...
    /**
	 * <h3 class="en">Getter method for identified value</h3>
	 * <h3 class="zh-CN">数据块验证值的Getter方法</h3>
	 *
	 * @return 	<span class="en">Block data identified value of SHA256</span>
	 * 			<span class="zh-CN">数据块验证值，使用SHA256</span>
	 */
    ...
    /**
	 * <h3 class="en">Getter method for block data information</h3>
	 * <h3 class="zh-CN">数据块信息的Getter方法</h3>
	 *
	 * @return 	<span class="en">Block data information, base64 encoded data bytes</span>
	 * 			<span class="zh-CN">数据块信息，使用Base64编码</span>
	 */
    ...
    /**
	 * <h3 class="en">Getter method for block generate time</h3>
	 * <h3 class="zh-CN">数据块生成时间的Getter方法</h3>
	 *
	 * @return 	<span class="en">Block generate time</span>
	 * 			<span class="zh-CN">数据块生成时间</span>
	 */
	...
	/**
	 * <h3 class="en">Verify current data block</h3>
	 * <h3 class="zh-CN">验证当前数据块</h3>
	 *
	 * @return 	<span class="en"><code>true</code> for valid, <code>false</code> for invalid</span>
