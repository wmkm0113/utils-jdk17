...
/**
 * <h2 class="en">Segment Data Information Define</h2>
...
public final class SegmentationInfo extends BeanObject {
	...
	/**
	 * <span class="en">Total data size</span>
	...
	/**
	 * <span class="en">File extension name</span>
	...
	private String sha;
	/**
	 * <span class="en">Block data list</span>
	...
	/**
     * <h3 class="en">Default constructor for SegmentationInfo</h3>
     * <h3 class="zh-CN">SegmentationInfo的默认构造函数</h3>
	 */
	public SegmentationInfo() {
	}
	/**
     * <h3 class="en">Constructor for SegmentationInfo</h3>
     * <span class="en">Using given extension name, total size, block size, identified value and block list</span>
     * <h3 class="zh-CN">SegmentationInfo的构造函数</h3>
     * <span class="zh-CN">使用给定的文件扩展名，数据大小，文件验证码以及数据块列表</span>
	 *
	 * @param extName 		<span class="en">File extension name</span>
	 *                      <span class="zh-CN">文件扩展名</span>
	 * @param totalSize     <span class="en">Total data size</span>
	 * 						<span class="zh-CN">数据大小</span>
	 * @param blockSize     <span class="en">Block data size</span>
	 * 						<span class="zh-CN">数据块大小</span>
	 * @param sha           <span class="en">Block data identified value of SHA256</span>
	 * 						<span class="zh-CN">数据块验证值，使用SHA256</span>
	 * @param blockList 	<span class="en">Block data list</span>
	 * 						<span class="zh-CN">数据块列表</span>
	 */
    ...
    /**
	 * <h3 class="en">Getter method for total data size</h3>
	 * <h3 class="zh-CN">数据大小的Getter方法</h3>
	 *
	 * @return 	<span class="en">Total data size</span>
	 * 			<span class="zh-CN">数据大小</span>
	 */
	...
	/**
	 * <h3 class="en">Getter method for file extension name</h3>
	 * <h3 class="zh-CN">文件扩展名的Getter方法</h3>
	 *
	 * @return 	<span class="en">File extension name</span>
	 * 			<span class="zh-CN">文件扩展名</span>
	 */
	...
	/**
	 * <h3 class="en">Getter method for block data list</h3>
	 * <h3 class="zh-CN">数据块列表的Getter方法</h3>
	 *
	 * @return 	<span class="en">Block data list</span>
	 * 			<span class="zh-CN">数据块列表</span>
	 */
