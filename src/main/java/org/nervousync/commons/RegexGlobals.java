...
public final class RegexGlobals {
	/**
	 * <span class="en-US">Regular expression for match email address.</span>
	...
	/**
	 * <span class="en-US">Regular expression for match IPv6 address.</span>
	...
	/**
	 * <span class="en-US">Regular expression for match IPv6 compress address.</span>
	...
	/**
	 * <span class="en-US">Regular expression for match phone number.</span>
