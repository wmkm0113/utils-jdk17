...
/**
 * <h2 class="en">Proxy server configure</h2>
...
public final class ProxyConfig extends BeanObject {
    ...
    /**
	 * <h3 class="en">Constructor method for ProxyConfig</h3>
	 * <h3 class="zh-CN">ProxyConfig构造方法</h3>
     */
    public ProxyConfig() {
    }
    /**
	 * <h3 class="en">Static method for create redirect ProxyConfig instance</h3>
	 * <h3 class="zh-CN">静态方法用于创建无代理的代理服务器配置信息实例对象</h3>
     *
     * @return  <span class="en">Generated ProxyConfig instance</span>
	...
	/**
	 * <h3 class="en">Getter method for proxy type</h3>
	 * <h3 class="zh-CN">代理服务器类型的Getter方法</h3>
	 *
     * @return  <span class="en">Enumeration value of proxy type</span>
     *          <span class="zh-CN">代理服务器类型枚举值</span>
	 */
	...
	/**
	 * <h3 class="en">Setter method for proxy type</h3>
	 * <h3 class="zh-CN">代理服务器类型的Setter方法</h3>
	 *
     * @param proxyType     <span class="en">Enumeration value of proxy type</span>
     *                      <span class="zh-CN">代理服务器类型枚举值</span>
	 */
	 ...
	 * <h3 class="zh-CN">代理服务器类型的Getter方法</h3>
     *
     * @return  <span class="en">Proxy server address</span>
     *          <span class="zh-CN">代理服务器地址</span>
     */
	 ...
	 * <h3 class="zh-CN">代理服务器类型的Setter方法</h3>
     *
     * @param proxyAddress  <span class="en">Proxy server address</span>
     *                      <span class="zh-CN">代理服务器地址</span>
     */
	 ...
	 * <h3 class="zh-CN">代理服务器类型的Getter方法</h3>
     *
     * @return  <span class="en">Proxy server port</span>
     *          <span class="zh-CN">代理服务器端口号</span>
     */
	 ...
	 * <h3 class="zh-CN">代理服务器类型的Setter方法</h3>
     *
     * @param proxyPort     <span class="en">Proxy server port</span>
     *                      <span class="zh-CN">代理服务器端口号</span>
     */
	 ...
	 * <h3 class="zh-CN">代理服务器类型的Getter方法</h3>
     *
     * @return  <span class="en">Authenticate username</span>
     *          <span class="zh-CN">身份认证用户名</span>
     */
	 ...
	 * <h3 class="zh-CN">代理服务器类型的Getter方法</h3>
     *
     * @return  <span class="en">Authenticate password</span>
     *          <span class="zh-CN">身份认证密码</span>
     */
