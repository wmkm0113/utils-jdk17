...
/**
 * <h2 class="en">Abstract asymmetric crypto adapter class</h2>
...
public abstract class AsymmetricCryptoAdapter extends BaseCryptoAdapter {
    ...
    /**
     * <span class="en">Cipher block length</span>
     * <span class="zh-CN">加密块长度</span>
     */
    private final int blockLength;
    /**
     * <span class="en">Cipher block size</span>
     * <span class="zh-CN">块数据大小</span>
     */
    private final int blockSize;
    /**
     * <span class="en">Data append buffer</span>
     * <span class="zh-CN">数据填充缓冲器</span>
     */
    private byte[] appendBuffer;
    /**
     * <span class="en">Result data bytes</span>
     * <span class="zh-CN">结果数据二进制数组</span>
     */
    private byte[] dataBytes;
    /**
     * <span class="en">Signature instance</span>
     * <span class="zh-CN">签名实例对象</span>
     */
    protected Signature signature;
    /**
     * <h3 class="en">Constructor for AsymmetricCryptoAdapter</h3>
    ...
    /**
	 * <h3 class="en">Append parts of given binary data array to data append buffer</h3>
    ...
    /**
	 * <h3 class="en">Process append buffer data</h3>
    ...
    /**
	 * <h3 class="en">Concat binary data arrays</h3>
	 * <h3 class="zh-CN">处理追加缓冲区中的数据</h3>
     *
     * @param dataBytes     <span class="en">Original data bytes</span>
     *                      <span class="zh-CN">原有字节数组</span>
     * @param concatBytes   <span class="en">Concat data bytes</span>
     *                      <span class="zh-CN">合并连接的字节数组</span>
     *
     * @return  <span class="en">Concat data bytes</span>
    ...
    /**
	 * <h3 class="en">Abstract method for initialize signature instance</h3>
	 * <h3 class="zh-CN">抽象方法用于初始化签名实例对象</h3>
     *
     * @return  <span class="en">Initialized signature instance</span>
