...
/**
 * <h2 class="en">Abstract basic crypto adapter class</h2>
...
public abstract class BaseCryptoAdapter extends SecureAdapter {
    ...
    /**
	 * <h3 class="en">Abstract method for initialize cipher instance</h3>
	 * <h3 class="zh-CN">抽象方法用于初始化加密解密实例对象</h3>
     *
     * @return  <span class="en">Initialized cipher instance</span>
    ...
    /**
	 * <h3 class="en">Generate cipher instance using given parameters</h3>
	 * <h3 class="zh-CN">根据给定的参数信息初始化加密解密实例对象</h3>
     *
     * @param key       <span class="en">Crypto key</span>
     *                  <span class="zh-CN">加密解密密钥</span>
     * @param ivLength  <span class="en">Length of IV data array</span>
     *                  <span class="zh-CN">向量二进制数据的长度</span>
     *
     * @return  <span class="en">Generated cipher instance</span>
     *          <span class="zh-CN">生成的加密解密密钥</span>
     *
     * @throws CryptoException
     * <span class="en">If an error occurs when generate cipher</span>
    ...
    /**
     * <h2 class="en">Cipher key define</h2>
    ...
    public static final class CipherKey {
        /**
         * <span class="en">Key size</span>
         * <span class="zh-CN">密钥长度</span>
         */
        private final int keySize;
        /**
         * <span class="en">Key data bytes</span>
         * <span class="zh-CN">密钥字节数组</span>
         */
        private final byte[] keyBytes;
        /**
         * <span class="en">Random algorithm</span>
         * <span class="zh-CN">随机数算法</span>
         */
        private final String randomAlgorithm;
        /**
         * <span class="en">Asymmetric crypto key instance</span>
         * <span class="zh-CN">非对称算法密钥实例对象</span>
         */
        private final Key key;

        /**
         * <h3 class="en">Constructor for CipherKey</h3>
         ...
         * <h3 class="zh-CN">加密解密密钥定义的构造方法</h3>
         *
         * @param key   <span class="en">Asymmetric crypto key instance</span>
         *              <span class="zh-CN">非对称算法密钥实例对象</span>
         */
        ...
        /**
         * <h3 class="en">Getter method for Key size</h3>
         * <h3 class="zh-CN">密钥长度的Getter方法</h3>
         *
         * @return  <span class="en">Key size</span>
         *          <span class="zh-CN">密钥长度</span>
         */
        ...
        /**
         * <h3 class="en">Getter method for Key data bytes</h3>
         * <h3 class="zh-CN">密钥字节数组的Getter方法</h3>
         *
         * @return  <span class="en">Key data bytes</span>
         *          <span class="zh-CN">密钥字节数组</span>
         */
        ...
        /**
         * <h3 class="en">Getter method for Random algorithm</h3>
         * <h3 class="zh-CN">随机数算法的Getter方法</h3>
         *
         * @return  <span class="en">Random algorithm</span>
         *          <span class="zh-CN">随机数算法</span>
         */
        ...
        /**
         * <h3 class="en">Getter method for Asymmetric crypto key instance</h3>
         * <h3 class="zh-CN">非对称算法密钥实例对象的Getter方法</h3>
         *
         * @return  <span class="en">Asymmetric crypto key instance</span>
         *          <span class="zh-CN">非对称算法密钥实例对象</span>
         */
        public Key getKey() {
            return key;
