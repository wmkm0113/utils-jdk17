...
public final class CollectionUtils {
	 ...
	 * <span class="en-US">if the parameter is not an array</span>
	 ...
	 *
	 * @return
	 * <span class="en-US">a value of the given type found if there is a clear match, or <code>null</code> if none or more than one such value found</span>
