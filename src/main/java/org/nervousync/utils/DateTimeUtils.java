...
public final class DateTimeUtils {
	 ...
	 * <span class="en-US">If parameter string is null or empty string</span>
	 ...
	 *
	 * @throws ParseException
	 * <span class="en-US">if given string could not be properly parsed according to given locale and style</span>
	 ...
	 * <span class="en-US">if given string could not be properly parsed according to given pattern string</span>
