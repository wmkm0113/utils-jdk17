...
public final class ServiceUtils {
     ...
     * @throws MalformedURLException <span class="en">if no protocol is specified, or an unknown protocol is found, or spec is null.</span>
    ...
    private record RestfulInterceptor(String requestPath, Map<String, String> headerMap) implements InvocationHandler {
         ...
         * @throws ServiceException <span class="en">If http method not supported</span>
         ...
         * @throws ServiceException <span class="en">If http method not supported, or an error occurs when send request or parse response information</span>
